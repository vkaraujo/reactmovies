    ...
    return(
        <div className="flex h-screen">
            <div className='w-1/2 relative'>
                <Link to={'/filmes'}>
                    <img src={capaFilmes} alt="filmes" className="w-full h-full object-cover opacity-70 hover:opacity-100 transition-all"/>
                </Link>
            ...
            <div className='w-1/2 relative'>
                <Link to={'/series'}>
                    <img src={capaSeries} alt="series" className="w-full h-full object-cover opacity-70 hover:opacity-100 transition-all"/>
                </Link>
